...
box-sizing: border-box;
  ...
  <nav class="w3-sidebar w3-card-4 w3-bar-block w3-theme-14 w3-collapse w3-top" style="z-index:3;width:274px" id="mySidebar">
    ...
    <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
      <a href="dashboard.php" class="w3-bar-item w3-button current_page"><i class="fas fa-tachometer-alt w3-margin-right" style="font-size:24px"></i>DASHBOARD</a>
...
<div class="w3-container w3-content w3-center bg-white py-5" style="max-width:800px">
    ...
    <div id="main-content">
        <h2 class="mt-5 text-center mb-5">Month of <?php echo $currentMonth; ?></h2>
        <div class="text-start">
            <div class="card mb-3">
                <h5 class="mt-3 text-center">Weekly Report</h5>
                <div class="card-body">
                    <canvas id="weeklyDynamicRepREV" height="85"></canvas>
                </div>
            </div>
        </div>


        <div class="text-start justify-content-between mt-5">
            <div class="card mb-3">
                <h5 class="mt-3 text-center">Monthly Report</h5>
                <div class="card-body">
                    <canvas id="monthlyDynamicRepREV" height="85"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="text-start">
            <div class="card mb-3">
                <h5 class="mt-3 text-center">Yearly Report</h5>
                <div class="card-body">
                    <canvas id="yearlyDynamicRepREV" height="85"></canvas>
                </div>
            </div>
        </div>
